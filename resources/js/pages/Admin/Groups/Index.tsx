...
export default function GroupsIndex({ groups, instructors, filters = {} }: PageProps) {
    ...
    const applyFilters = (newSearch: string, newInst: string) => {
        router.get('/admin/groups', { search: newSearch, instructor_id: newInst }, { preserveState: true, replace: true });
    };

    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        applyFilters(search, instructorId);
    };
