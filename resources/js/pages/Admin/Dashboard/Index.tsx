        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Maktabning umumiy holati va ko'rsatkichlari</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-card border rounded-xl p-6 flex flex-col justify-between shadow-sm">
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-medium text-muted-foreground">Umumiy Talabalar</h3>
                ...
                <div className="bg-card border rounded-xl p-6 flex flex-col justify-between shadow-sm">
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-medium text-muted-foreground">O'rtacha KPI (%)</h3>
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-xs text-muted-foreground">Tanlangan davr uchun o'rtacha ko'rsatkich</p>
                    </div>
                </div>
                <div className="bg-card border rounded-xl p-6 flex flex-col justify-between shadow-sm">
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-medium text-muted-foreground">Oylik Mashg'ulotlar</h3>
                    ...
                    <div className="mt-4">
                        <span className="text-3xl font-bold">{metrics.monthlyDrivings}</span>
                    </div>
                </div>
                <div className="bg-card border rounded-xl p-6 flex flex-col justify-between shadow-sm">
                    <div className="flex items-center justify-between">
                        <h3 className="text-sm font-medium text-muted-foreground">Oylik Tugatish Darajasi</h3>
            ...
            <div className="bg-card border rounded-xl p-6 shadow-sm">
                <h3 className="text-lg font-semibold mb-4">Shu oydagi kunlik mashg'ulotlar</h3>
